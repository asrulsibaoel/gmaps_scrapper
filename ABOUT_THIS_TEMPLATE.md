...
├── gmaps_scrapper             # The main python package for the project
...
Just click on [Use this template](https://github.com/asrulsibaoel/python-project-template/generate) and you are good to go.
...
e.g: `cat gmaps_scrapper/VERSION` will get the project version without harming
